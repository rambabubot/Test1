...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001765935167').split()]
...
HOW_TO_VERIFY = environ.get('HOW_TO_VERIFY', "https://t.me/movielinkopan/12")
VERIFY2_URL = environ.get('VERIFY2_URL', "greymatterslinks.in")
VERIFY2_API = environ.get('VERIFY2_API', "78e1e16e5b5bfd96625c5f1101acb6b815965b90")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'greymatterslinks.in')
SHORTLINK_API = environ.get('SHORTLINK_API', '78e1e16e5b5bfd96625c5f1101acb6b815965b90')
